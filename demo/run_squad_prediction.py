...
def run_prediction(sent1,sent2,model):
    ...
    if model=='squad2-better-bert-base':
        ...
        args.model_name_or_path = '../models/demo-models/squad2-qamr-better-roberta-large'
        args.model_type = 'roberta'
    elif model=='squad2-qamr-better-balanced-roberta-large':
        args.model_name_or_path = '../models/demo-models/squad2-qamr-better-balanced-roberta-large'
        args.model_type = 'roberta'
