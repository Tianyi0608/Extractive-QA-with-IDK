...
def run_prediction(sent1,sent2,model):
    ...
    if model=='squad2-better-bert-base':
        ...
        args.model_type = 'bert'
    # elif model=='squad2-qamr-better-roberta-large':
    #     args.model_name_or_path = '/shared/zty/BETTER-Cogcomp/granular-event/models/demo-models/squad2-qamr-better-roberta-large'
    #     args.model_type = 'roberta'
    # elif model=='squad2-qamr-better-balanced-roberta-large':
    #     args.model_name_or_path = '/shared/zty/BETTER-Cogcomp/granular-event/models/demo-models/squad2-qamr-better-balanced-roberta-large'
    #     args.model_type = 'roberta'
    ...
    with open(args.output_dir+"nbest_predictions_.json",'r') as f:
        ...
        for i in range(len(preds_processed) - 1, -1, -1):
            if preds_processed[i]["text"]=='' and i==len(preds_processed) - 1:
                continue
